...
class CHE(ForwardIVP):
    ...
    def r_net(self, params, t, x):
        ...
        u3_xx = grad(grad(self.u_net(params, t, x)**3, argnums=2), argnums=2)(params, t, x)
        
        res = u_t + 0.25*u_xx + 0.00025*u_xxxx + 0.05*u - 0.25*u3_xx  # cahn-hilliard extended equation
    ...
    def res_net(self, params, t, x):
        res, _ = self.r_net(params, t, x)
        return res
    
    def bc_net(self, params, t, x):
        _, bc = self.r_net(params, t, x)
        return bc
    ...
    def res_and_w(self, params, batch):
        ...
        r_pred = vmap(self.res_net, (None, 0, 0))(params, t_sorted, batch[:, 1])
    ...
    def losses(self, params, batch):
        ...
        # bc_pred = vmap(self.bc_net, (None, 0, 0))(params, bc_batch[:, 0], bc_batch[:, 1])
        ...
        if self.config.weighting.use_causal == True:
            ...
            r_pred = vmap(self.res_net, (None, 0, 0))(params, res_batch[:, 0], res_batch[:, 1])
...
class CHEEvaluator(BaseEvaluator):
    ...
    def __call__(self, state, batch, u_ref):
        ...
        if self.config.weighting.use_causal:
            _, causal_weight = self.model.res_and_w(state.params, batch['res'])
